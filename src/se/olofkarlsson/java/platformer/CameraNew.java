 ...
 * http://slick.javaunlimited.net/viewtopic.php?p=11204&sid=
 * 74a7b2372a4f650a8c978b11fe02e13a#p11204
 * 
 * @author koopa
 * 
 */
...
public class CameraNew {
	 ...
	 */
	public CameraNew(GameContainer gc, TiledMap map) {
		this.map = map;
	...
	/**
	 * draws the part of the map which is currently focused by the camera on the
	 * screen
	 */
	public void drawMap() {
		this.drawMap(0, 0);
